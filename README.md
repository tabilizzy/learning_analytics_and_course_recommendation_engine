...
| ` Users `	      | about 100             |
| ` Courses`      |	 about 50             |
| ` Activity Logs`|	about 1000            |
| `Enrollments`   |	about 300             |
|  `Reviews	`     | about 150             |
...
The system includes queries to generate insights about learner engagement.
...
The project supports dashboard analytics such as:

- Daily Active Users (DAU)

- Number of unique users performing activity each day.
...
- Measures how many enrolled users complete course activities.

- Category Growth Trends

- Tracks engagement growth by category over the past 6 months.
